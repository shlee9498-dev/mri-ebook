...
[이미지 플레이스홀더: 서바이버 달성 증거 — 유튜브 쇼츠 화면(3,712 RP 서바이버 표기) 캡처, 증거영상 QR(https://youtube.com/shorts/iBUe3IH-frM)]
...
[그래프 플레이스홀더: 10일 점수 흐름 — 미션으로 인한 하락 구간 표시, 3,400→3,700 구간(3일) 강조]
